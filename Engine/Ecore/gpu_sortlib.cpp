...
namespace pf::gpusortlib
{
	...
	void LoadShaders()
	{
		pf::renderer::LoadShader(ShaderStage::CS, kickoffSortCS, "gpusortlib_kickoffSortCS.cso");
		pf::renderer::LoadShader(ShaderStage::CS, sortCS, "gpusortlib_sortCS.cso");
		pf::renderer::LoadShader(ShaderStage::CS, sortInnerCS, "gpusortlib_sortInnerCS.cso");
		pf::renderer::LoadShader(ShaderStage::CS, sortStepCS, "gpusortlib_sortStepCS.cso");
	...
	void Initialize()
	{
		...
		pf::graphics::GetDevice()->CreateBuffer(&bd, nullptr, &indirectBuffer);
		...
		p_log("pf::gpusortlib Initialized (%d ms)", (int)std::round(timer.elapsed()));
	}
