...
#include "renderer.h"
#include "Shader/ShaderInterop_FFTGenerator.h"
#include <stdio.h>
#include <stdlib.h>
#include <assert.h>
...
namespace pf::fftgenerator
{
	...
	struct CSFFT512x512_Plan
	{
		...
		pf::graphics::GPUBuffer pRadix008A_CB[6];

		pf::graphics::GPUBuffer pBuffer_Tmp;
...
#define FFT_INVERSE 1
	...
	void LoadShaders()
	{
		pf::renderer::LoadShader(ShaderStage::CS, radix008A_CS, "fft_512x512_c2c_CS.cso");
		pf::renderer::LoadShader(ShaderStage::CS, radix008A_CS2, "fft_512x512_c2c_v2_CS.cso");
	}
