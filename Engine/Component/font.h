...
namespace pf::font {
	...
	struct Params
	{
		...
		pf::Color color; // base color of the text characters
		pf::Color shadowColor; // transparent disables, any other color enables shadow under text
		float h_wrap = -1; // wrap start width (-1 default for no wrap) (logical canvas units)
		int style = 0; // 0: use default font style, other values can be taken from the pf::font::AddFontStyle() funtion's return value
		...
		Params(
			...
			pf::Color color = pf::Color(255, 255, 255, 255),
			pf::Color shadowColor = pf::Color(0, 0, 0, 0)
		) :
	...
	const pf::graphics::Texture* GetAtlas();
	...
	void SetCanvas(const pf::Canvas& current_canvas);
	...
	//	in pf::font::Params::cursor
	Cursor Draw(const char* text, size_t text_length, const Params& params, pf::graphics::CommandList cmd);
	Cursor Draw(const wchar_t* text, size_t text_length, const Params& params, pf::graphics::CommandList cmd);
	Cursor Draw(const char* text, const Params& params, pf::graphics::CommandList cmd);
	Cursor Draw(const wchar_t* text, const Params& params, pf::graphics::CommandList cmd);
	Cursor Draw(const std::string& text, const Params& params, pf::graphics::CommandList cmd);
	Cursor Draw(const std::wstring& text, const Params& params, pf::graphics::CommandList cmd);
