...
namespace pf
{
	...
	public:
		...
		pf::Resource fontStyleResource;
		std::string fontStyleName;

		SpriteFont() = default;
		SpriteFont(const std::string& value, const pf::font::Params& params = pf::font::Params(), const std::string& fontStyleName = "") :params(params), fontStyleName(fontStyleName)
		{
			SetText(value);
		...
		pf::primitive::AABB GetAABB() const;
