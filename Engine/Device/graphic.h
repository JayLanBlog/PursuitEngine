...
namespace pf::graphics {
	...
	{
		vector<ShaderLibrary> shader_libraries;
		vector<ShaderHitGroup> hit_groups;
...
template<>
struct enable_bitmask_operators<pf::graphics::ColorWrite> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<pf::graphics::BindFlag> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<pf::graphics::ResourceMiscFlag> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<pf::graphics::GraphicsDeviceCapability> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<pf::graphics::ResourceState> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<pf::graphics::RenderPassDesc::Flags> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<pf::graphics::RenderPassFlags> {
	static const bool enable = true;
};
template<>
struct enable_bitmask_operators<pf::graphics::VideoDecoderSupportFlags> {
	static const bool enable = true;
};
...
{
	template <>
	struct hash<pf::graphics::PipelineHash>
	{
		inline uint64_t operator()(const pf::graphics::PipelineHash& hash) const
		{
