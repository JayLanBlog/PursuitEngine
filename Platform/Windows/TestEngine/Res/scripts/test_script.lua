...
-- Load a model:
local parent = LoadModel("Res/models/teapot.wiscene");
LoadModel("Res/models/cameras.wiscene");

-- Load camera sample script:
dofile("Res/scripts/camera_animation_repeat.lua");
ToggleCameraAnimation();

-- Load an image:
local sprite = Sprite("Res/logo_small.png");
--sprite.SetTexture(
