...
static const std::string SHADER_INTEROP_PATH = pf::helper::GetCurrentPath() + "/" + pf::helper::GetDirectoryFromPath(pf::helper::GetPathRelative(pf::helper::GetCurrentPath(), std::string(__FILE__)));
