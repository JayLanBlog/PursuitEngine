...
static const uint SURFEL_INDIRECT_OFFSET_RAYTRACE = pf::graphics::AlignTo(SURFEL_INDIRECT_OFFSET_ITERATE + 4 * 3, IndirectDispatchArgsAlignment);
static const uint SURFEL_INDIRECT_OFFSET_INTEGRATE = pf::graphics::AlignTo(SURFEL_INDIRECT_OFFSET_RAYTRACE + 4 * 3, IndirectDispatchArgsAlignment);
