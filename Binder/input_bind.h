...
namespace Luaer
{
	...
	public:
		...
		Touch_BindLua(const pf::input::Touch& touch) :touch(touch) {}
	...
	public:
		...
		ControllerFeedback_BindLua(const pf::input::ControllerFeedback& feedback) :feedback(feedback) {}
