...
namespace Luaer
{
	...
	public:
		...
		SpriteAnim_BindLua(const pf::Sprite::Anim& anim);
	...
	{
	public:
		pf::Sprite::Anim::MovingTexAnim anim;
		...
		MovingTexAnim_BindLua(const pf::Sprite::Anim::MovingTexAnim& anim);
	...
	{
	public:
		pf::Sprite::Anim::DrawRectAnim anim;
		...
		DrawRectAnim_BindLua(const pf::Sprite::Anim::DrawRectAnim& anim);
