...
namespace Luaer::scene {
	...
	{
	private:
		std::unique_ptr<pf::scene::Scene> owning; // GetScene() is too slow if scene object is always constructed
	public:
		pf::scene::Scene* scene = nullptr;
		...
		Scene_BindLua(pf::scene::Scene* scene) :scene(scene) {}
		Scene_BindLua(lua_State* L) : owning(std::make_unique<pf::scene::Scene>()), scene(owning.get()) {}
	...
	public:
		...
		pf::scene::Scene::RayIntersectionResult result;

		RayIntersectionResult_BindLua() = default;
		RayIntersectionResult_BindLua(lua_State* L) {}
		RayIntersectionResult_BindLua(const pf::scene::Scene::RayIntersectionResult& result) : result(result) {}
		RayIntersectionResult_BindLua(pf::scene::Scene::RayIntersectionResult&& result) : result(std::move(result)) {}
	...
	public:
		...
		pf::scene::Scene::SphereIntersectionResult result;

		SphereIntersectionResult_BindLua() = default;
		SphereIntersectionResult_BindLua(lua_State* L) {}
		SphereIntersectionResult_BindLua(const pf::scene::Scene::SphereIntersectionResult& result) : result(result) {}
		SphereIntersectionResult_BindLua(pf::scene::Scene::SphereIntersectionResult&& result) : result(std::move(result)) {}
	...
	{
	private:
		pf::scene::NameComponent owning;
	public:
		pf::scene::NameComponent* component = nullptr;
		...
		NameComponent_BindLua(pf::scene::NameComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::LayerComponent owning;
	public:
		pf::scene::LayerComponent* component = nullptr;
		...
		LayerComponent_BindLua(pf::scene::LayerComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::TransformComponent owning;
	public:
		pf::scene::TransformComponent* component = nullptr;
		...
		TransformComponent_BindLua(pf::scene::TransformComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		pf::scene::CameraComponent owning;
	public:
		pf::scene::CameraComponent* component = nullptr;
		...
		CameraComponent_BindLua(pf::scene::CameraComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::AnimationComponent owning;
	public:
		pf::scene::AnimationComponent* component = nullptr;
		...
		AnimationComponent_BindLua(pf::scene::AnimationComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::MaterialComponent owning;
	public:
		pf::scene::MaterialComponent* component = nullptr;
		...
		MaterialComponent_BindLua(pf::scene::MaterialComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		pf::scene::MeshComponent owning;
	public:
		pf::scene::MeshComponent* component = nullptr;
		...
		MeshComponent_BindLua(pf::scene::MeshComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		pf::EmittedParticleSystem owning;
	public:
		pf::EmittedParticleSystem* component = nullptr;
		...
		EmitterComponent_BindLua(pf::EmittedParticleSystem* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		pf::HairParticleSystem owning;
	public:
		pf::HairParticleSystem* component = nullptr;
	...
	{
	private:
		pf::scene::LightComponent owning;
	public:
		pf::scene::LightComponent* component = nullptr;
		...
		LightComponent_BindLua(pf::scene::LightComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::ObjectComponent owning;
	public:
		pf::scene::ObjectComponent* component = nullptr;
		...
		ObjectComponent_BindLua(pf::scene::ObjectComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::InverseKinematicsComponent owning;
	public:
		pf::scene::InverseKinematicsComponent* component = nullptr;
		...
		InverseKinematicsComponent_BindLua(pf::scene::InverseKinematicsComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::SpringComponent owning;
	public:
		pf::scene::SpringComponent* component = nullptr;
		...
		SpringComponent_BindLua(pf::scene::SpringComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		pf::scene::ScriptComponent owning;
	public:
		pf::scene::ScriptComponent* component = nullptr;
		...
		ScriptComponent_BindLua(pf::scene::ScriptComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::RigidBodyPhysicsComponent owning;
	public:
		pf::scene::RigidBodyPhysicsComponent* component = nullptr;
		...
		RigidBodyPhysicsComponent_BindLua(pf::scene::RigidBodyPhysicsComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		pf::scene::SoftBodyPhysicsComponent owning;
	public:
		pf::scene::SoftBodyPhysicsComponent* component = nullptr;
		...
		inline void BuildBindings()
		{
			Mass = Luaer::FloatProperty(&component->mass);
			Friction = Luaer::FloatProperty(&component->friction);
			Restitution = Luaer::FloatProperty(&component->restitution);
			VertexRadius = Luaer::FloatProperty(&component->vertex_radius);
		}

		SoftBodyPhysicsComponent_BindLua(pf::scene::SoftBodyPhysicsComponent* component) :component(component)
		{
			BuildBindings();
		}
		...
		Luaer::FloatProperty Mass;
		Luaer::FloatProperty Friction;
		Luaer::FloatProperty Restitution;
		Luaer::FloatProperty VertexRadius;
	...
	{
	private:
		pf::scene::ForceFieldComponent owning;
	public:
		pf::scene::ForceFieldComponent* component = nullptr;
		...
		ForceFieldComponent_BindLua(pf::scene::ForceFieldComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		pf::Ocean::OceanParameters owning;
	public:
		pf::Ocean::OceanParameters* parameter = nullptr;
		...
		Weather_OceanParams_BindLua(pf::Ocean::OceanParameters* parameter) :parameter(parameter)
		{
			BuildBindings();
		}
	...
	{
		pf::Ocean::OceanParameters* data = nullptr;
		Weather_OceanParams_Property() {}
		Weather_OceanParams_Property(pf::Ocean::OceanParameters* data) :data(data) {}
		int Get(lua_State* L);
		int Set(lua_State* L);
	};
	...
	{
	private:
		pf::scene::WeatherComponent owning;
	public:
		pf::scene::WeatherComponent* component = nullptr;
		...
		WeatherComponent_BindLua(pf::scene::WeatherComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		pf::scene::SoundComponent owning;
	public:
		pf::scene::SoundComponent* component = nullptr;
		...
		SoundComponent_BindLua(pf::scene::SoundComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		pf::scene::VideoComponent owning;
	public:
		pf::scene::VideoComponent* component = nullptr;
		...
		VideoComponent_BindLua(pf::scene::VideoComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		pf::scene::ColliderComponent owning;
	public:
		pf::scene::ColliderComponent* component = nullptr;
		...
		ColliderComponent_BindLua(pf::scene::ColliderComponent* component) :component(component)
		{
			BuildBindings();
		}
	...
	{
	private:
		pf::scene::ExpressionComponent owning;
	public:
		pf::scene::ExpressionComponent* component = nullptr;
		...
		ExpressionComponent_BindLua(pf::scene::ExpressionComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::HumanoidComponent owning;
	public:
		pf::scene::HumanoidComponent* component = nullptr;
		...
		HumanoidComponent_BindLua(pf::scene::HumanoidComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::DecalComponent owning;
	public:
		pf::scene::DecalComponent* component = nullptr;
		...
		DecalComponent_BindLua(pf::scene::DecalComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::MetadataComponent owning;
	public:
		pf::scene::MetadataComponent* component = nullptr;
		...
		MetadataComponent_BindLua(pf::scene::MetadataComponent* component) :component(component) {}
	...
	{
	private:
		pf::scene::CharacterComponent owning;
	public:
		pf::scene::CharacterComponent* component = nullptr;
		...
		CharacterComponent_BindLua(pf::scene::CharacterComponent* component) :component(component) {}
