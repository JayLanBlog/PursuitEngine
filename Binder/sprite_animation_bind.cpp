...
namespace Luaer
{
	...
	SpriteAnim_BindLua::SpriteAnim_BindLua(const pf::Sprite::Anim& anim) :anim(anim)
	{
	}
	...
	int SpriteAnim_BindLua::SetRot(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.rot = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetRot(float rot) not enough arguments!");
		}
		return 0;
	}
	...
	int SpriteAnim_BindLua::SetOpacity(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.opa = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetOpacity(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetFade(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.fad = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetFade(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetWobbleAnimAmount(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.wobbleAnim.amount = XMFLOAT2(Luaer::SGetFloat(L, 1), Luaer::SGetFloat(L, 1));
		}
		else
		{
			Luaer::SError(L, "SetWobbleAnimAmount(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetWobbleAnimSpeed(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.wobbleAnim.speed = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetWobbleAnimSpeed(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetRepeatable(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.repeatable = Luaer::SGetBool(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetRepeatable(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetVelocity(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			{
				Luaer::SError(L, "SetVelocity(Vector val) argument is not a Vector!");
			}
		}
		else
		{
			Luaer::SError(L, "SetVelocity(Vector val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetScaleX(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.scaleX = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetScaleX(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetScaleY(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.scaleY = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetScaleY(float val) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetMovingTexAnim(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			{
				Luaer::SError(L, "SetMovingTexAnim(MovingTexAnim data) argument is not a MovingTexAnim!");
			}
		}
		else
		{
			Luaer::SError(L, "SetMovingTexAnim(MovingTexAnim data) not enough arguments!");
		}
		return 0;
	}
	int SpriteAnim_BindLua::SetDrawRecAnim(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			{
				Luaer::SError(L, "SetDrawRecAnim(DrawRecAnim data) argument is not a DrawRecAnim!");
			}
		}
		else
		{
			Luaer::SError(L, "SetDrawRecAnim(DrawRecAnim data) not enough arguments!");
		}
		return 0;
	}
	...
	{
		Luaer::SSetFloat(L, anim.scaleX);
		return 1;
	}
	int SpriteAnim_BindLua::GetScaleY(lua_State* L)
	{
		Luaer::SSetFloat(L, anim.scaleY);
		return 1;
	}
	...
	void SpriteAnim_BindLua::Bind()
	{
		...
		{
			initialized = true;
			Luna<SpriteAnim_BindLua>::Register(Luaer::GetLuaState());
			Luna<MovingTexAnim_BindLua>::Register(Luaer::GetLuaState());
			Luna<DrawRectAnim_BindLua>::Register(Luaer::GetLuaState());
		}
	}
	...
	MovingTexAnim_BindLua::MovingTexAnim_BindLua(const pf::Sprite::Anim::MovingTexAnim& anim) :anim(anim)
	{
	}

	MovingTexAnim_BindLua::MovingTexAnim_BindLua(lua_State* L)
	{
		anim = pf::Sprite::Anim::MovingTexAnim();
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			anim.speedX = Luaer::SGetFloat(L, 1);
			if (argc > 1)
			{
				anim.speedY = Luaer::SGetFloat(L, 2);
			}
		}
	}
	...
	int MovingTexAnim_BindLua::SetSpeedX(lua_State* L)
	{
		...
		{
			Luaer::SError(L, "SetSpeedX(float val) not enough arguments!");
		}
		return 0;
	}
	int MovingTexAnim_BindLua::SetSpeedY(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.speedY = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetSpeedY(float val) not enough arguments!");
		}
		return 0;
	}
	...
	{
		Luaer::SSetFloat(L, anim.speedX);
		return 1;
	}
	int MovingTexAnim_BindLua::GetSpeedY(lua_State* L)
	{
		Luaer::SSetFloat(L, anim.speedY);
		return 1;
	}
	...
	DrawRectAnim_BindLua::DrawRectAnim_BindLua(const pf::Sprite::Anim::DrawRectAnim& anim) :anim(anim)
	{
	}

	DrawRectAnim_BindLua::DrawRectAnim_BindLua(lua_State* L)
	{
		anim = pf::Sprite::Anim::DrawRectAnim();
	}
	...
	int DrawRectAnim_BindLua::SetFrameRate(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.frameRate = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetFrameRate(float val) not enough arguments!");
		}
		return 0;
	}
	int DrawRectAnim_BindLua::SetFrameCount(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.frameCount = Luaer::SGetInt(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetFrameCount(int val) not enough arguments!");
		}
		return 0;
	}
	int DrawRectAnim_BindLua::SetHorizontalFrameCount(lua_State* L)
	{
		...
		if (argc > 0)
		{
			anim.horizontalFrameCount = Luaer::SGetInt(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetHorizontalFrameCount(int val) not enough arguments!");
		}
		return 0;
	}
