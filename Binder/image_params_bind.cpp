...
namespace Luaer {
	...
	ImageParams_BindLua::ImageParams_BindLua(const pf::image::Params& params) :params(params)
	{
	}
	...
	{
		Luaer::SSetFloat(L, params.border_soften);
		return 1;
	}
	...
	{
		Luaer::SSetBool(L, params.isDrawRectEnabled());
		return 1;
	}
	int ImageParams_BindLua::IsDrawRect2Enabled(lua_State* L)
	{
		Luaer::SSetBool(L, params.isDrawRect2Enabled());
		return 1;
	}
	int ImageParams_BindLua::IsMirrorEnabled(lua_State* L)
	{
		Luaer::SSetBool(L, params.isMirrorEnabled());
		return 1;
	}
	int ImageParams_BindLua::IsBackgroundBlurEnabled(lua_State* L)
	{
		Luaer::SSetBool(L, params.isBackgroundEnabled());
		return 1;
	}
	...
	{
		Luaer::SSetBool(L, params.isDistortionMaskEnabled());
		return 1;
	}
	...
	int ImageParams_BindLua::SetSize(lua_State* L)
	{
		...
		{
			Luaer::SError(L, "SetSize(Vector size) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::SetPivot(lua_State* L)
	{
		...
		{
			Luaer::SError(L, "SetPivot(Vector value) not enough arguments!");
		}
		return 0;
	}
	...
	int ImageParams_BindLua::SetOpacity(lua_State* L)
	{
		...
		if (argc > 0)
		{
			params.opacity = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetOpacity(float x) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::SetSaturation(lua_State* L)
	{
		...
		if (argc > 0)
		{
			params.saturation = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetSaturation(float x) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::SetFade(lua_State* L)
	{
		...
		if (argc > 0)
		{
			params.fade = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetFade(float x) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::SetStencil(lua_State* L)
	{
		...
		if (argc > 1)
		{
			params.stencilComp = (pf::image::STENCILMODE)Luaer::SGetInt(L, 1);
			params.stencilRef = (uint8_t)Luaer::SGetInt(L, 2);
		}
		else
		{
			Luaer::SError(L, "SetStencil(int stencilmode,stencilref) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::SetStencilRefMode(lua_State* L)
	{
		...
		if (argc > 0)
		{
			params.stencilRefMode = (pf::image::STENCILREFMODE)Luaer::SGetInt(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetStencilRefMode(int stencilrefmode) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::SetBlendMode(lua_State* L)
	{
		...
		if (argc > 0)
		{
			params.blendFlag = (pf::enums::BLENDMODE)Luaer::SGetInt(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetBlendMode(int blendMode) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::SetQuality(lua_State* L)
	{
		...
		if (argc > 0)
		{
			params.quality = (pf::image::QUALITY)Luaer::SGetInt(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetQuality(int quality) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::SetSampleMode(lua_State* L)
	{
		...
		if (argc > 0)
		{
			params.sampleFlag = (pf::image::SAMPLEMODE)Luaer::SGetInt(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetSampleMode(int sampleMode) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::SetRotation(lua_State* L)
	{
		...
		if (argc > 0)
		{
			params.rotation = Luaer::SGetFloat(L, 1);
		}
		else
		{
	...
	int ImageParams_BindLua::SetTexOffset(lua_State* L)
	{
		...
		{
			Luaer::SError(L, "SetTexOffset(Vector value) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::SetTexOffset2(lua_State* L)
	{
		...
		{
			Luaer::SError(L, "SetTexOffset2(Vector value) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::SetBorderSoften(lua_State* L)
	{
		...
		if (argc > 0)
		{
			params.border_soften = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetBorderSoften(float alpha) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::EnableDrawRect(lua_State* L)
	{
		...
		{
			Luaer::SError(L, "EnableDrawRect(Vector value) not enough arguments!");
		}
		return 0;
	}
	int ImageParams_BindLua::EnableDrawRect2(lua_State* L)
	{
		...
		{
			Luaer::SError(L, "EnableDrawRect2(Vector value) not enough arguments!");
		}
		return 0;
	}
	...
	int ImageParams_BindLua::SetMaskAlphaRange(lua_State* L)
	{
		...
		if (argc < 2)
		{
			Luaer::SError(L, "SetMaskAlphaRange(float start, end): not enough arguments!");
			return 0;
		}
		params.mask_alpha_range_start = Luaer::SGetFloat(L, 1);
		params.mask_alpha_range_end = Luaer::SGetFloat(L, 2);
		return 0;
	}
	int ImageParams_BindLua::GetMaskAlphaRange(lua_State* L)
	{
		Luaer::SSetFloat(L, params.mask_alpha_range_start);
		Luaer::SSetFloat(L, params.mask_alpha_range_end);
		return 2;
	}
	...
	int ImageParams_BindLua::SetAngularSoftnessDirection(lua_State* L)
	{
		...
		if (argc < 1)
		{
			Luaer::SError(L, "SetAngularSoftnessDirection(Vector value) : not enough arguments!");
			return 0;
		}
		Vector_BindLua* v = Luna<Vector_BindLua>::lightcheck(L, 1);
		if (v == nullptr)
		{
			Luaer::SError(L, "SetAngularSoftnessDirection(Vector value) : first argument is not a Vector!");
			return 0;
		}
	...
	int ImageParams_BindLua::SetAngularSoftnessInnerAngle(lua_State* L)
	{
		...
		if (argc < 1)
		{
			Luaer::SError(L, "SetAngularSoftnessInnerAngle(float value) : not enough arguments!");
			return 0;
		}
		params.angular_softness_inner_angle = Luaer::SGetFloat(L, 1);
		return 0;
	}
	int ImageParams_BindLua::SetAngularSoftnessOuterAngle(lua_State* L)
	{
		...
		if (argc < 1)
		{
			Luaer::SError(L, "SetAngularSoftnessOuterAngle(float value) : not enough arguments!");
			return 0;
		}
		params.angular_softness_outer_angle = Luaer::SGetFloat(L, 1);
		return 0;
	}
	...
	ImageParams_BindLua::ImageParams_BindLua(lua_State* L)
	{
		...
		if (argc > 0)
		{
			if (argc < 3)//w
			{
				w = Luaer::SGetFloat(L, 1);
				if (argc > 1)//h
				{
					h = Luaer::SGetFloat(L, 2);
				}
			}
			else {//x,y,w
				x = Luaer::SGetFloat(L, 1);
				y = Luaer::SGetFloat(L, 2);
				w = Luaer::SGetFloat(L, 3);
				if (argc > 3)//h
				{
					h = Luaer::SGetFloat(L, 4);
				}
			}
		}
		params = pf::image::Params(x, y, w, h);
	}
	...
	void ImageParams_BindLua::Bind()
	{
		...
		{
			initialized = true;
			Luna<ImageParams_BindLua>::Register(Luaer::GetLuaState());
