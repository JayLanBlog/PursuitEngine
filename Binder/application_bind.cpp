...
#include "render_path_bind.h"
#include "render_path_3d_bind.h"
#include "render_path_2d_bind.h"
...
namespace Luaer {
	...
	int Application_BindLua::GetActivePath(lua_State* L)
	{
		...
		{
			Luaer::SError(L, "GetActivePath() component is empty!");
			return 0;
		}
		...
		Luaer::SError(L, "GetActivePath() Warning: type of active component not registered!");
		return 0;
	}
	int Application_BindLua::SetActivePath(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetActivePath(RenderPath component) component is empty!");
			return 0;
		}
		...
		{
			float fadeSeconds = 0;
			pf::Color fadeColor = pf::Color(0, 0, 0, 255);
			pf::FadeManager::FadeType fadetype = pf::FadeManager::FadeType::FadeToColor;
			if (argc > 1)
			{
				fadeSeconds = Luaer::SGetFloat(L, 2);
				if (argc > 2)
				{
					fadeColor.setR((uint8_t)Luaer::SGetInt(L, 3));
					if (argc > 3)
					{
						fadeColor.setG((uint8_t)Luaer::SGetInt(L, 4));
						if (argc > 4)
						{
							fadeColor.setB((uint8_t)Luaer::SGetInt(L, 5));
							if (argc > 5)
							{
								fadetype = (pf::FadeManager::FadeType)Luaer::SGetInt(L, 6);
							}
						}
					}
				}
		...
		{
			Luaer::SError(L, "SetActivePath(RenderPath component, opt int fadeFrames,fadeColorR,fadeColorG,fadeColorB) not enought arguments!");
			return 0;
		}
		return 0;
	}
	int Application_BindLua::SetFrameSkip(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetFrameSkip(bool enabled) component is empty!");
			return 0;
		}
		...
		if (argc > 0)
		{
			component->setFrameSkip(Luaer::SGetBool(L, 1));
		}
		else
			Luaer::SError(L, "SetFrameSkip(bool enabled) not enought arguments!");
		return 0;
	}
	int Application_BindLua::SetFullScreen(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetFullScreen(bool enabled) component is empty!");
			return 0;
		}
		...
		if (argc > 0)
		{
			component->SetFullScreen(Luaer::SGetBool(L, 1));
		}
		else
			Luaer::SError(L, "SetFullScreen(bool enabled) not enought arguments!");
		return 0;
	}
	int Application_BindLua::SetTargetFrameRate(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetTargetFrameRate(float value) component is empty!");
			return 0;
		}
		...
		if (argc > 0)
		{
			component->setTargetFrameRate(Luaer::SGetFloat(L, 1));
		}
		else
			Luaer::SError(L, "SetTargetFrameRate(float value) not enought arguments!");
		return 0;
	}
	int Application_BindLua::SetFrameRateLock(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetFrameRateLock(bool enabled) component is empty!");
			return 0;
		}
		...
		if (argc > 0)
		{
			component->setFrameRateLock(Luaer::SGetBool(L, 1));
		}
		else
			Luaer::SError(L, "SetFrameRateLock(bool enabled) not enought arguments!");
		return 0;
	}
	int Application_BindLua::SetInfoDisplay(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetInfoDisplay() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			component->infoDisplay.active = Luaer::SGetBool(L, 1);
		}
		else
			Luaer::SError(L, "SetInfoDisplay(bool active) not enough arguments!");
		return 0;
	}
	int Application_BindLua::SetWatermarkDisplay(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetWatermarkDisplay() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			component->infoDisplay.watermark = Luaer::SGetBool(L, 1);
		}
		else
			Luaer::SError(L, "SetWatermarkDisplay(bool active) not enough arguments!");
		return 0;
	}
	int Application_BindLua::SetFPSDisplay(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetFPSDisplay() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			component->infoDisplay.fpsinfo = Luaer::SGetBool(L, 1);
		}
		else
			Luaer::SError(L, "SetFPSDisplay(bool active) not enough arguments!");
		return 0;
	}
	int Application_BindLua::SetResolutionDisplay(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetResolutionDisplay() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			component->infoDisplay.resolution = Luaer::SGetBool(L, 1);
		}
		else
			Luaer::SError(L, "SetResolutionDisplay(bool active) not enough arguments!");
		return 0;
	}
	int Application_BindLua::SetLogicalSizeDisplay(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetLogicalSizeDisplay() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			component->infoDisplay.logical_size = Luaer::SGetBool(L, 1);
		}
		else
			Luaer::SError(L, "SetLogicalSizeDisplay(bool active) not enough arguments!");
		return 0;
	}
	int Application_BindLua::SetColorSpaceDisplay(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetColorSpaceDisplay() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			component->infoDisplay.colorspace = Luaer::SGetBool(L, 1);
		}
		else
			Luaer::SError(L, "SetColorSpaceDisplay(bool active) not enough arguments!");
		return 0;
	}
	int Application_BindLua::SetPipelineCountDisplay(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetPipelineCountDisplay() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			component->infoDisplay.pipeline_count = Luaer::SGetBool(L, 1);
		}
		else
			Luaer::SError(L, "SetPipelineCountDisplay(bool active) not enough arguments!");
		return 0;
	}
	int Application_BindLua::SetHeapAllocationCountDisplay(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetHeapAllocationCountDisplay() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			component->infoDisplay.heap_allocation_counter = Luaer::SGetBool(L, 1);
		}
		else
			Luaer::SError(L, "SetHeapAllocationCountDisplay(bool active) not enough arguments!");
		return 0;
	}
	int Application_BindLua::SetVRAMUsageDisplay(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetVRAMUsageDisplay() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			component->infoDisplay.vram_usage = Luaer::SGetBool(L, 1);
		}
		else
			Luaer::SError(L, "SetVRAMUsageDisplay(bool active) not enough arguments!");
		return 0;
	}
	int Application_BindLua::SetColorGradingHelper(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetColorGradingHelper() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			component->infoDisplay.colorgrading_helper = Luaer::SGetBool(L, 1);
		}
		else
			Luaer::SError(L, "SetColorGradingHelper(bool active) not enough arguments!");
		return 0;
	}
	int Application_BindLua::Fade(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "Fade(float fadeSeconds = 1, opt int fadeColorR = 0, fadeColorG = 0, fadeColorB = 0, FadeType fadetype = FadeType.FadeToColor) component is empty!");
			return 0;
		}
		...
		if (argc > 0)
		{
			fadeSeconds = Luaer::SGetFloat(L, 1);
			if (argc > 1)
			{
				fadeColor.setR((uint8_t)Luaer::SGetInt(L, 2));
				if (argc > 2)
				{
					fadeColor.setG((uint8_t)Luaer::SGetInt(L, 3));
					if (argc > 3)
					{
						fadeColor.setB((uint8_t)Luaer::SGetInt(L, 4));
						if (argc > 4)
						{
							fadetype = (pf::FadeManager::FadeType)Luaer::SGetInt(L, 5);
						}
					}
				}
			}
	...
	int Application_BindLua::CrossFade(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "CrossFade(float fadeSeconds = 1) component is empty!");
			return 0;
		}
		...
		component->Fade(fadeSeconds, pf::Color::Black(), pf::FadeManager::FadeType::CrossFade);
		return 0;
	}

	int Application_BindLua::IsHDRSupported(lua_State* L)
	{
		Luaer::SSetBool(L, pf::graphics::GetDevice()->IsSwapChainSupportsHDR(&component->swapChain));
		return 1;
	}
	int Application_BindLua::SetHDR(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetHDR() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			component->allow_hdr = Luaer::SGetBool(L, 1);
			component->swapChain.desc.allow_hdr = component->allow_hdr;
			bool success = pf::graphics::GetDevice()->CreateSwapChain(&component->swapChain.desc, nullptr, &component->swapChain);
			assert(success);
		}
		else
			Luaer::SError(L, "SetHDR(bool active) not enough arguments!");
		return 0;
	}
	...
	int Application_BindLua::GetCanvas(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "GetCanvas() component is empty!");
			return 0;
		}
	...
	int Application_BindLua::SetCanvas(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "SetCanvas() component is empty!");
			return 0;
		}
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
		{
			...
			{
				Luaer::SError(L, "SetCanvas(canvas canvas) first parameter is not a Canvas!");
			}
		}
		else
		{
			Luaer::SError(L, "SetCanvas(canvas canvas) not enough arguments!");
		}
		return 1;
	}
	...
	int Application_BindLua::IsFaded(lua_State* L)
	{
		if (component == nullptr)
		{
			Luaer::SError(L, "IsFaded() component is empty!");
			return 0;
		}
		Luaer::SSetBool(L, component->IsFaded());
		return 1;
	}
	...
	int SetProfilerEnabled(lua_State* L)
	{
		...
		if (argc > 0)
		{
			pf::profiler::SetEnabled(Luaer::SGetBool(L, 1));
		}
		else
			Luaer::SError(L, "SetProfilerEnabled(bool active) not enough arguments!");

		return 0;
	}
	int prof(lua_State* L)
	{
		pf::profiler::SetEnabled(!pf::profiler::IsEnabled());
		return 0;
	}
	...
	void Application_BindLua::Bind()
	{
		...
		{
			initialized = true;
			Luna<Application_BindLua>::Register(Luaer::GetLuaState());

			Luaer::RegisterFunc("SetProfilerEnabled", SetProfilerEnabled);
			Luaer::RegisterFunc("prof", prof);
...
FadeType = {
	...
	{
		Luaer::SSetFloat(L, canvas.GetDPI());
		return 1;
	}
	int Canvas_BindLua::GetDPIScaling(lua_State* L)
	{
		Luaer::SSetFloat(L, canvas.GetDPIScaling());
		return 1;
	}
	int Canvas_BindLua::GetCustomScaling(lua_State* L)
	{
		Luaer::SSetFloat(L, canvas.scaling);
		return 1;
	}
	int Canvas_BindLua::SetCustomScaling(lua_State* L)
	{
		...
		if (argc > 0)
		{
			canvas.scaling = Luaer::SGetFloat(L, 1);
		}
		else
		{
			Luaer::SError(L, "SetCustomScaling(float scaling) not enough arguments!");
		}
		return 0;
	}
	int Canvas_BindLua::GetPhysicalWidth(lua_State* L)
	{
		Luaer::SSetInt(L, canvas.GetPhysicalWidth());
		return 1;
	}
	int Canvas_BindLua::GetPhysicalHeight(lua_State* L)
	{
		Luaer::SSetInt(L, canvas.GetPhysicalHeight());
		return 1;
	}
	int Canvas_BindLua::GetLogicalWidth(lua_State* L)
	{
		Luaer::SSetFloat(L, canvas.GetLogicalWidth());
		return 1;
	}
	int Canvas_BindLua::GetLogicalHeight(lua_State* L)
	{
		Luaer::SSetFloat(L, canvas.GetLogicalHeight());
		return 1;
	}
	...
	void Canvas_BindLua::Bind()
	{
		...
		{
			initialized = true;
			Luna<Canvas_BindLua>::Register(Luaer::GetLuaState());
		}
	}
