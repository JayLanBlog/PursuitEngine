...
namespace Luaer {
	...
	public:
		...
		Sound_BindLua(const pf::audio::Sound& sound)
		{
			soundResource.SetSound(sound);
		}
		Sound_BindLua(const pf::Resource resource)
		{
	...
	public:
		...
		SoundInstance_BindLua(const pf::audio::SoundInstance& instance)
		{
	...
	{
	public:
		pf::audio::SoundInstance3D soundinstance3D;
		...
		SoundInstance3D_BindLua(const pf::audio::SoundInstance3D& soundinstance3D) : soundinstance3D(soundinstance3D) {}
