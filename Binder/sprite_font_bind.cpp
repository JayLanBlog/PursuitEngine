...
namespace Luaer {
	...
	SpriteFont_BindLua::SpriteFont_BindLua(const pf::SpriteFont& font) : font(font)
	{
	}
	...
	int SpriteFont_BindLua::SetStyle(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			font.fontStyleResource = pf::resourcemanager::Load(name);
		}
		else
		{
			Luaer::SError(L, "SetStyle(string style, opt int size = 16) not enough arguments!");
		}
		return 0;
	}
	int SpriteFont_BindLua::SetText(lua_State* L)
	{
		int argc = Luaer::SGetArgCount(L);
		if (argc > 0)
			font.SetText(Luaer::SGetString(L, 1));
		else
			font.SetText("");
		return 0;
	}
	int SpriteFont_BindLua::SetSize(lua_State* L)
	{
		...
		if (argc > 0)
		{
			font.params.size = Luaer::SGetInt(L, 1);
		}
		else
			Luaer::SError(L, "SetSize(int size) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetScale(lua_State* L)
	{
		...
		if (argc > 0)
		{
			font.params.scaling = Luaer::SGetFloat(L, 1);
		}
		else
			Luaer::SError(L, "SetScale(float scale) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetPos(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			if (param != nullptr)
			{
				...
				Luaer::SError(L, "SetPos(Vector pos) argument is not a vector!");
		}
		else
			Luaer::SError(L, "SetPos(Vector pos) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetSpacing(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			if (param != nullptr)
			{
				...
				Luaer::SError(L, "SetSpacing(Vector spacing) argument is not a vector!");
		}
		else
			Luaer::SError(L, "SetSpacing(Vector spacing) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetAlign(lua_State* L)
	{
		...
		if (argc > 0)
		{
			font.params.h_align = (pf::font::Alignment)Luaer::SGetInt(L, 1);
			if (argc > 1)
			{
				font.params.v_align = (pf::font::Alignment)Luaer::SGetInt(L, 2);
			}
		}
		else
			Luaer::SError(L, "SetAlign(WIFALIGN Halign, opt WIFALIGN Valign) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetColor(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			if (param != nullptr)
			{
				font.params.color = pf::Color::fromFloat4(param->data);
			}
			else
			{
				int code = Luaer::SGetInt(L, 1);
	...
	int SpriteFont_BindLua::SetShadowColor(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			if (param != nullptr)
			{
				font.params.shadowColor = pf::Color::fromFloat4(param->data);
			}
			else
			{
				int code = Luaer::SGetInt(L, 1);
			...
			Luaer::SError(L, "SetShadowColor(Vector value) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetBolden(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			Luaer::SError(L, "SetBolden(float value) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetSoftness(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			Luaer::SError(L, "SetSoftness(float value) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetShadowBolden(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			Luaer::SError(L, "SetShadowBolden(float value) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetShadowSoftness(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			Luaer::SError(L, "SetShadowSoftness(float value) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetShadowOffset(lua_State* L)
	{
		...
		if (argc > 0)
		{
			...
			if (param != nullptr)
			{
				...
				Luaer::SError(L, "SetShadowOffset(Vector pos) argument is not a vector!");
		}
		else
			Luaer::SError(L, "SetShadowOffset(Vector pos) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetHorizontalWrapping(lua_State* L)
	{
		...
		if (argc > 0)
		{
			font.params.h_wrap = Luaer::SGetFloat(L, 1);
		}
		else
			Luaer::SError(L, "SetHorizontalWrapping(float value) not enough arguments!");
		return 0;
	}
	int SpriteFont_BindLua::SetHidden(lua_State* L)
	{
		...
		if (argc > 0)
		{
			font.SetHidden(Luaer::SGetBool(L, 1));
		}
		else
	...
	int SpriteFont_BindLua::SetFlippedHorizontally(lua_State* L)
	{
		...
		if (argc < 1)
		{
			Luaer::SError(L, "SetFlippedHorizontally(bool value) not enough arguments!");
			return 0;
		}
		bool enabled = Luaer::SGetBool(L, 1);
		if (enabled)
		{
	...
	int SpriteFont_BindLua::SetFlippedVertically(lua_State* L)
	{
		...
		if (argc < 1)
		{
			Luaer::SError(L, "SetFlippedVertically(bool value) not enough arguments!");
			return 0;
		}
		bool enabled = Luaer::SGetBool(L, 1);
		if (enabled)
	...
	{
		Luaer::SSetString(L, font.GetTextA());
		return 1;
	}
	int SpriteFont_BindLua::GetSize(lua_State* L)
	{
		Luaer::SSetInt(L, font.params.size);
		return 1;
	}
	int SpriteFont_BindLua::GetScale(lua_State* L)
	{
		Luaer::SSetFloat(L, font.params.scaling);
		return 1;
	}
	...
	{
		Luaer::SSetInt(L, font.params.h_align);
		Luaer::SSetInt(L, font.params.v_align);
		return 2;
	}
	...
	{
		Luaer::SSetFloat(L, font.params.bolden);
		return 1;
	}
	int SpriteFont_BindLua::GetSoftness(lua_State* L)
	{
		Luaer::SSetFloat(L, font.params.softness);
		return 1;
	}
	int SpriteFont_BindLua::GetShadowBolden(lua_State* L)
	{
		Luaer::SSetFloat(L, font.params.shadow_bolden);
		return 1;
	}
	int SpriteFont_BindLua::GetShadowSoftness(lua_State* L)
	{
		Luaer::SSetFloat(L, font.params.shadow_softness);
		return 1;
	}
	...
	{
		Luaer::SSetFloat(L, font.params.h_wrap);
		return 1;
	}
	int SpriteFont_BindLua::IsHidden(lua_State* L)
	{
		Luaer::SSetBool(L, font.IsHidden());
		return 1;
	}
	int SpriteFont_BindLua::IsFlippedHorizontally(lua_State* L)
	{
		Luaer::SSetBool(L, font.params.isFlippedHorizontally());
		return 1;
	}
	int SpriteFont_BindLua::IsFlippedVertically(lua_State* L)
	{
		Luaer::SSetBool(L, font.params.isFlippedVertically());
		return 1;
	}
	...
	int SpriteFont_BindLua::SetTypewriterTime(lua_State* L)
	{
		...
		if (argc < 1)
		{
			Luaer::SError(L, "SetTypewriterTime(float value) not enough arguments!");
		}
		font.anim.typewriter.time = Luaer::SGetFloat(L, 1);
		return 0;
	}
	int SpriteFont_BindLua::SetTypewriterLooped(lua_State* L)
	{
		...
		if (argc < 1)
		{
			Luaer::SError(L, "SetTypewriterLooped(bool value) not enough arguments!");
		}
		font.anim.typewriter.looped = Luaer::SGetBool(L, 1);
		return 0;
	}
	int SpriteFont_BindLua::SetTypewriterCharacterStart(lua_State* L)
	{
		...
		if (argc < 1)
		{
			Luaer::SError(L, "SetTypewriterCharacterStart(int value) not enough arguments!");
		}
		font.anim.typewriter.character_start = (size_t)Luaer::SGetLongLong(L, 1);
		return 0;
	}
	int SpriteFont_BindLua::SetTypewriterSound(lua_State* L)
	{
		...
		if (argc < 2)
		{
			Luaer::SError(L, "SetTypewriterSound(Sound sound, SoundInstance soundinstance) not enough arguments!");
			return 0;
		}
		Sound_BindLua* sound = Luna<Sound_BindLua>::lightcheck(L, 1);
		if (sound == nullptr)
		{
			Luaer::SError(L, "SetTypewriterSound(Sound sound, SoundInstance soundinstance) first argument is not a sound!");
			return 0;
		}
		SoundInstance_BindLua* soundinstance = Luna<SoundInstance_BindLua>::lightcheck(L, 2);
		if (soundinstance == nullptr)
		{
			Luaer::SError(L, "SetTypewriterSound(Sound sound, SoundInstance soundinstance) second argument is not a sound instance!");
			return 0;
		}
	...
	{
		Luaer::SSetBool(L, font.anim.typewriter.IsFinished());
		return 1;
	}
	...
	void SpriteFont_BindLua::Bind()
	{
		...
		{
			initialized = true;
			Luna<SpriteFont_BindLua>::Register(Luaer::GetLuaState());
